// This is the click action for the What we do section
...
// This is the hover effect for the Portfolio Section
$(document).ready(function () {
...
// This section will pick data from the form and return a message
$(document).ready(function () {
  ...
  function validateData() {
    ...
    $(".contactus").submit(function () {
      if (getName == "") {
        ...
        alert("Kindly provide your message");
      } else {
        alert(
          "Thank you " +
            getName +
            ". We have successfully received your feedback and are acting upon it."
        );
      }
    });
  }
